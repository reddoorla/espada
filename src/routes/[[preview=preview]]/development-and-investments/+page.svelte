  ...
  <ContentWidth class="flex flex-col gap-20 items-center pb-12">
    ...
    <div class="w-full flex flex-col md:flex-row justify-between items-start gap-12">
      <div class="w-full md:w-[calc(50%-24px)]">
        <FourByThreeImage
          src={starbucks}
          alt="Drive-thru Starbucks developed by Espada Real Estate, photographed at sunset"
        />
      </div>
      <div
    ...
    <div class="w-full flex flex-col md:flex-row justify-between items-start gap-12">
      <div class="w-full md:w-[calc(50%-24px)]">
        <FourByThreeImage
          src={corner}
          alt="Mediterranean-style retail building developed by Espada, photographed at night"
        />
      </div>
      <div
        class="md:w-[calc(50%-24px)] border-t-2 border-t-black py-6 gap-6 flex flex-col text-black"
    ...
    <div class="w-full flex flex-col md:flex-row justify-between items-start gap-12">
      <div class="w-full md:w-[calc(50%-24px)]">
        <FourByThreeImage
          src={mcAlister}
          alt="McAlister's Deli storefront, an Espada development project"
        />
      </div>
      <div
        class="md:w-[calc(50%-24px)] border-t-2 border-t-black py-6 gap-6 flex flex-col text-black"
      >
        <h5>Our Network</h5>
        <p>
          Our extensive knowledge of many markets is just the beginning. We’ve spent years forging
          relationships with the people and organizations necessary for each project’s success.
        </p>
      </div>
    </div>
    ...
    <div class="w-full flex flex-col md:flex-row justify-between items-start gap-12">
      <div class="w-full md:w-[calc(50%-24px)]">
        <FourByThreeImage
          src={dollarStore}
          alt="Dollar Tree storefront at an Espada-developed retail center"
        />
      </div>
      <div
        class="md:w-[calc(50%-24px)] border-t-2 border-t-black py-6 gap-6 flex flex-col text-black"
      >
        <h5>Our Reach</h5>
        <p>
          Based in San Antonio, our reach has grown to include multiple Texas markets as well as
          select opportunities outside of Texas.
        </p>
      </div>
    </div>
  </ContentWidth>
  <ContentWidth class="border-t-2 border-black">
    <h2 class="text-black md:max-w-2xl my-16">
      We are adept at executing every phase of development.
    </h2>
    <div class="w-full flex flex-col md:flex-row mb-32">
      <p class="md:w-1/2 text-black leading-loose">
        Market Research <br />
        Site Selection<br />
        Assemblage & Acquisition<br />
        Project Design & Efficiency<br />
        Land Entitlement<br />
        Public Agency Coordination<br />
        Pro Forma Analysis<br />
        Consultant Team Selection<br />
      ...
      <p class="md:w-1/2 text-black leading-loose">
        ...
        Asset Management<br />
        Accounting<br />
        Project Leasing & Land Sales<br />
        Property Management<br />
        Asset Disposition<br />
        Fee Development
      </p>
    </div>
  </ContentWidth>
      ...
      {#each projectArray as proj, i}
        <div class="w-full md:w-[calc(50%-24px)]">
          ...
          <div class="mt-12 border-t-2 border-black w-full">
            <button
              class="w-full flex flex-row justify-between items-center h-20"
